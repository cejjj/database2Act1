...
-- Started on 2019-12-17 16:20:23
...
--
-- TOC entry 196 (class 1259 OID 1829202)
-- Name: tutorial; Type: TABLE; Schema: public; Owner: dmmhrdisrntogz
--
...
ALTER TABLE public.tutorial OWNER TO dmmhrdisrntogz;

--
-- TOC entry 3820 (class 0 OID 1829202)
-- Dependencies: 196
-- Data for Name: tutorial; Type: TABLE DATA; Schema: public; Owner: dmmhrdisrntogz
--
...
-- Dependencies: 3
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: dmmhrdisrntogz
--

REVOKE ALL ON SCHEMA public FROM postgres;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
GRANT ALL ON SCHEMA public TO dmmhrdisrntogz;
...
GRANT ALL ON LANGUAGE plpgsql TO dmmhrdisrntogz;


-- Completed on 2019-12-17 16:20:44
